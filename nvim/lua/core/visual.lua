...
return {{"navarasu/onedark.nvim", config = _2_}, {"hoob3rt/lualine.nvim", dependencies = "kyazdani42/nvim-web-devicons", opts = {options = {theme = "onedark", component_separators = {left = "", right = ""}, section_separators = {left = "", right = ""}}}}, {"akinsho/bufferline.nvim", dependencies = "kyazdani42/nvim-web-devicons", opts = {options = {diagnostics = "nvim_lsp", offsets = {{filetype = "NvimTree", text = "", padding = 1}}}}}, "lukas-reineke/indent-blankline.nvim", "szw/vim-maximizer", {"folke/which-key.nvim", config = _3_}, {"folke/todo-comments.nvim", dependencies = "nvim-lua/plenary.nvim", opts = {keywords = {DELETEME = {icon = "\226\156\151", color = "error"}, TODO = {icon = "\239\128\140 ", color = "info"}, HACK = {icon = "\239\146\144 ", color = "warning"}, WARN = {icon = "\239\129\177 ", color = "warning", alt = {"WARNING", "XXX"}}, NOTE = {icon = "\239\161\167 ", color = "hint", alt = {"INFO"}}}, highlight = {pattern = ".*<(KEYWORDS)\\s*:?"}}}, {"Grazfather/blinker.nvim", config = true}, {"goolord/alpha-nvim", dependencies = {"kyazdani42/nvim-web-devicons"}, config = _4_}, {"folke/noice.nvim", config = true, dependencies = {"MunifTanjim/nui.nvim"}}, {"akinsho/toggleterm.nvim", opts = {open_mapping = "<c-\\>", direction = "tab"}}}
